...
POST /api/v1/issues/{id}/automate_batch                — разбор «общей» заявки по объектам (по вложению на ТС)
...
**Гос.номер латиница↔кириллица**: канонизация (A759PC → А759РС) в `_norm_plate` — клиенты пишут латиницей.
