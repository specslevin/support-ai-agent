...
- **Дашборд заявок**: список с фильтрами/пагинацией (запоминается), детали из Okdesk, комментарии, смена статуса/типа/ответственного.
...
| Метод | Путь | Описание |
|---|---|---|
| GET | `/api/v1/issues` | Список заявок (фильтры, пагинация) |
