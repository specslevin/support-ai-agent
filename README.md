...
- **Разбор «общих» заявок**: для заявок с несколькими вложениями (акт на ТС) — таблица вердиктов по каждому объекту (🗺 трек каждого ТС), массовый ответ про глушение и создание вложенных заявок по объектам с корректными данными.
