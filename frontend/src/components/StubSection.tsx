...
const META: Record<Exclude<Section, 'issues'>, { icon: LucideIcon; title: string; desc: string; chart?: boolean }> = {
  mango: {
    icon: Phone,
...
export function StubSection({ section }: { section: Exclude<Section, 'issues'> }) {
