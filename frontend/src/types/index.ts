...
export interface BatchObject {
   ...
   * вердикт они не разжалуют (рваный трек сам признак глушения; км-вердикта по
   * моточасам и не бывает; схлопывание дублей верное), поэтому чип у них
   * спокойный (NON_DEMOTING_WARNINGS).
